...
PlatformSupport PlatformSupport32Bit() {
  ...
  if (support != nullptr) {
    ...
    QCHECK(false) << "GVISOR_PLATFORM_SUPPORT variable does not contain 32BIT "
                     "support information: "
                  << support;
  }
  QCHECK(false) << "GVISOR_PLATFORM_SUPPORT variable undefined";
}
...
PlatformSupport PlatformSupportInt3() {
  ...
  if (support != nullptr) {
    ...
    QCHECK(false) << "GVISOR_PLATFORM_SUPPORT variable does not contain INT3 "
                     "support information: "
                  << support;
  }
  QCHECK(false) << "GVISOR_PLATFORM_SUPPORT variable undefined";
